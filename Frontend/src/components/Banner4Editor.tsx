...
const Banner2Editor = () => {
  ...
  useEffect(() => {
    axios
      ...
      .catch(() => toast.error("❌ Erro ao carregar o banner da página register."));
  }, []);
  ...
  const handleSave = async () => {
    try {
      await axios.put("/banner/register", banner);
  ...
  return (
    <div className="container py-4">
      <h3 className="mb-3 fw-bold">Edição do Banner - Registar</h3>
